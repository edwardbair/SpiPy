...
def speedy_invert(F, R, R0, solarZ, shade, mode=3, scipy_options=scipy_options, method='SLSQP'):
    ...
    #     res1, res2 - mixed pixel (fsca,fshade,fother) vs snow only (fsca,fshade) solutions. One of those will be the same as res
    ...
    def snow_diff(x):
        ...
        # fill in model_reflectances for each band for snow properties
