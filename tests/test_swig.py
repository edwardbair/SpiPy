...
grain_size = 550
x0 = [f_sca, f_shade, dust_concentration, grain_size]


def test_interpolate_all():
    ret = interpolator.interpolate_all(solar_angle=solar_angle, dust_concentration=dust_concentration, grain_size=grain_size)
    expected = np.array([0.69418118, 0.72305336, 0.75899187, 0.76630307, 0.76921281, 0.75832135, 0.01766575, 0.02501143, 0.73101483])
...
def test_get_fsca():
    x = spires.core.get_fsca(spectrum_background,
                             spectrum_target,
                             solar_angle,
                             interpolator.bands,
    ...
    expected = np.array([4.908657e-01, 1.190273e-01, 5.405810e+02, 6.562301e+02])
...
def test_get_fscas():
    ...
    spires.core.get_fscas(spectra_backgrounds=spectra_backgrounds,
    ...
    expected = np.array([[4.908657e-01, 1.190273e-01, 5.405810e+02, 6.562301e+02],
                         [4.908657e-01, 1.190273e-01, 5.405810e+02, 6.562301e+02],
                         [4.908657e-01, 1.190273e-01, 5.405810e+02, 6.562301e+02]])
